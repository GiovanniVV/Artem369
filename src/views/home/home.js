...
import Contador, {PuntosResult} from '../Score/Score';
    ...
    (
      <View style={{height: '100%'}}>
        ...
        <View
          ...
          <View style={{padding: 10, top: 28, left: 310}}>
            <Score
              onPress={() => {
          ...
          <View style={{padding: 10, top: 86, left: 113, size: 20}}>
            <Paletas
              onPress={() => {
                navigation.navigate('pantallaPuntos');
              }}
            />
          </View>

          <View style={{padding: 20, top: 10, right: 5}}>
            <Avatar
              onPress={() => {
