    ...
    <View style={QuizStyles.backgroudImage}>
      <View style={QuizStyles.topUtils}>
        ...
        <View style={{alignSelf: 'center', bottom: 30}}>
          <Text style={QuizStyles.question}>¿Cuál fue antes?</Text>
        </View>
        <View>
          <CountdownCircleTimer
            ...
            size={80}
            onComplete={() => [
              navigation.navigate('feddbackNueveTiempoAgotado'),
            ]}
            colors={[
              ['#004777', 0.4],
              ['#F7B801', 0.4],
      ...
      <View
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('feddbackNueveIncorrecto');
            }}>
            <View style={{width: '40%'}}>
              <AutoHeightImage
                width={150}
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('feddbackNueveCorrecto');
            }}>
            <View style={{width: '40%'}}>
              <AutoHeightImage
                style={{borderColor: '#B8874A', borderWidth: 5}}
